https://github.com/Giveth/giveth-wiki/edit/master/wiki/documentation/deployments.md
...
The Main Donation address is the `Campaign` contract which catches tokens that can be taken out via the  and issues MYD tokens, then sends the ether to the vault. 
```
                              +------------------+
                              |                  |
                              |   MiniMeToken    |
...
Allows you to clone the token to upgrade the token, create a vote, offer select ICO access, basically give anyone that has this token the ability to do something special… this is permissionless too ;-) anyone can do this :-D
...
[0x58474228ffeebf58758bb661a4280df6aa433371](https://etherscan.io/address/0x58474228ffeebf58758bb661a4280df6aa433371#code)


####MYD token Contract
For this example we’re going to show you the power of upgrading a MiniMeToken!
The initial MYD deployment is at `0xf7e983781609012307f2514f63d526d83d24f466`. This will be our parent token. In order to make our cloned token we need to interact with the MiniMeToken [at this address](https://etherscan.io/address/0xf7e983781609012307f2514f63d526d83d24f466#readContract).
...
[0xa5a8ab2c69c27169a93fb52b8d52072ca61a4cdc](https://etherscan.io/address/0xa5a8ab2c69c27169a93fb52b8d52072ca61a4cdc#code)
...
[0x598ab825d607ace3b00d8714c0a141c7ae2e6822](https://etherscan.io/address/0x598ab825d607ace3b00d8714c0a141c7ae2e6822#code)
...
Remember this is a #BigNumber so give it some “” or the compiler will look at you funny.
...
[0x809af635bb8f1541eae4ecd00351c08700b5b476](https://etherscan.io/address/0x809af635bb8f1541eae4ecd00351c08700b5b476#readContract)


####MilestoneTracker 

While the `MilestoneTracker` contract is extremely complex deploying it is very simple!
...
https://etherscan.io/address/0xb438202e27991b04be6cae51e9ca4c15ddcbac55#code
...
For reference here’s some information on the main MEW addresses used in this tutorial.
